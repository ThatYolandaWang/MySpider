...
from myspider.items import TaobaoDataItem


class ItcastSpider(scrapy.Spider):
    name = "itcast" #蜘蛛标识
    allowed_domains = ['tmall.com']#["allegro.pl"]
    start_urls = []#("https://allegro.pl/listing?string=iphone15",) #["https://itcast.cn"]
    headers = {
        "Accept":"*/*",
    ...
    def start_requests(self):
        try:
            ...
            data ={"class2": ["毛衣女", "针织衫女"], "class1": "女装"}
...
#                self.start_urls.append("https://list.tmall.com/search_product.htm?spm=a220m.1000858.0.0.12753ba7yiUUUi&s=960&q="+key+"&sort=d&style=g&from=mallfp..pc_1_searchbutton&type=pc#J_Filter")
                for url in self.start_urls:
                    ...
                    yield scrapy.Request(url,cookies=self.cookies,headers=self.headers, meta={'class1':data['class1'],'class2':key},dont_filter=True)
